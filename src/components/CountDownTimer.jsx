...
const CountDownTimer = () => {
  ...
  return (
    <div className="countdown__container">
      <CountDownCard label=" D " number={days} cardRef={DaysCardRef} />
      <CountDownCard label=" H " number={hours} cardRef={HoursCardRef} />
      <CountDownCard label=" M " number={minutes} cardRef={MinutesCardRef} />
      <CountDownCard label=" S " number={seconds} cardRef={SecondsCardRef} />
    </div>
  );
};
